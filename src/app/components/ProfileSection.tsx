...
{/* Profile Section */}
<div id="home" className="bg-black text-white py-16 md:py-32 overflow-hidden">
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4">
    ...
    <div className="relative animate-float">
      ...
      <Image
        ...
        width={256} // Set appropriate width and height
      ...
      <div className="flex gap-6 text-2xl animate-slideUpFade delay-300">
        {[
          ...
          { 
            name: 'Facebook', 
            url: '#', 
            icon: '/facebook.png' // Path to your Facebook icon
          },
        ].map((social, index) => (
          <a
            key={social.name}
          ...
          >
            <div className="w-8 h-8 relative animate-popIn" style={{ animationDelay: `${index * 100}ms` }}>
              <Image 
                ...
                width={32} // Set appropriate width and height for the icons
                height={32}
              />
            </div>
          </a>
  ...
  <div className="container mx-auto text-center">
    ...
    <div className="mt-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {skills.map((skill, index) => (
        ...
        >
          <Image
            src={skill.logo} // Replace <img> with <Image />
            alt={skill.name}
...
<div id="about" className="py-16 md:py-24 bg-gray-900">
  <div className="container mx-auto text-center">
    ...
    <div className="mt-8 text-left max-w-3xl mx-auto px-4 space-y-6">
      ...
      {/* Challenges & Goals */}
      <div className="space-y-3 animate-slide-up-fade delay-500 mt=20">
...
<div id="services" className="py-16 md:py-24 bg-gray-900 animate-fadeIn">
  <div className="container mx-auto px-4">
    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition-all animate-fadeInUp">
      ...
      {/* UI/UX Design */}
      <div className="p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition-all animate-fadeInUp delay-100">
        <h3 className="text-xl font-semibold text-green-500 mb-3">
          🎨 UI/UX Design
        </h3>
        <p className="text-gray-300">
      ...
      {/* API Integration */}
      <div className="p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition-all animate-fadeInUp delay-200">
        <h3 className="text-xl font-semibold text-green-500 mb-3">
          🔌 API Integration
        </h3>
        <p className="text-gray-300">
      ...
      <div className="p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition-all animate-fadeInUp delay-300">
        <h3 className="text-xl font-semibold text-green-500 mb-3">
          📱 Front-End Development
        </h3>
        <p className="text-gray-300">
    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
      ...
      <div className="space-y-6 animate-fade-in-up">
        ...
        <div className="space-y-4">
          {[
            { 
              iconSrc: '/email.png',  // Removed extra space
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-start">
              ...
              <form className="space-y-4 w-full max-w-xs" onSubmit={(e) => e.preventDefault()}>
                <input 
                  type="text" 
